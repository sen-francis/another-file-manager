...
// Returns abbreviated string of month given index.
...
// Returns a vector of file names mactching search criteria.
...
// Moves input files into folder and deletes folder.
// Returns deleted folder path.
...
// Function registered keywords so functions can be called in JS.
